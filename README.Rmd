...
After installing the package, you can use a workflow like the following to use its functions. Click  [here](https://dsci-310-2024.github.io/predicttornado/articles/predicttornado-vignette.html)
