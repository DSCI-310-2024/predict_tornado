...
Moreover, `accuracy_plot` is very different because even though it uses `ggplot2` functions, no other package function creates a scatterplot that compares the accuracy of a linear regression model to the actual observations. 
