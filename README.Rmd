...
After installing the package, you can use a workflow like the following to use its functions. Click  [here](https://github.com/DSCI-310-2024/predicttornado/blob/main/vignettes/predicttornado-vignette.Rmd)
...
`predicttornado` was created by Erika Delorme, Marcela Flaherty, Riddha Tuladhar, and Edwin Yeung. It is licensed under the terms of the [MIT license](https://github.com/DSCI-310-2024/predicttornado/blob/main/LICENSE.md). 
